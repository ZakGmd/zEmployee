    ...
    <div className="flex h-screen bg-gray-100">
      ...
      <aside className="w-64 bg-white shadow-md">
        ...
        <nav className="mt-4">
          ...
          <Link to="/evaluation" className="flex items-center px-4 py-2 text-gray-700 hover:bg-gray-200">
            <BarChart2 className="mr-2" size={20} />
            Evaluation
          </Link>
          <Link to="/tasks" className="flex items-center px-4 py-2 text-gray-700 hover:bg-gray-200">
